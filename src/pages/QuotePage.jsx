...
const QuotePage = () => {
  return (
    <div className="h-auto w-full bg-[#ededed]">
      <main className="flex f-center mt-16 mb-16 pt-16 h-[85vh]">
        {/*Main Section*/}
        <section className="grid grid-cols-2 grid-rows-2 w-4/6 h-full">
          {/*Price Section*/}
          <section className="flex gap-4">
            <div className="h-[90%] w-5/12 bg-green-400 rounded-lg flex flex-col items-center justify-evenly">
            ...
            <div className="h-[90%] w-5/12 bg-white rounded-lg flex flex-col items-center justify-evenly">
          ...
          <section>
            <h2>Your Trip</h2>
            <div className="h-5/6 w-full bg-white shadow-xl rounded-sm"></div>
          </section>
          {/*Map Section*/}
          {/*Information Section*/}
          ...
          {/*Information Section*/}
          {/*Continue Section*/}
          <section className="bg-white rounded-lg w-full h-4/6 flex f-center">
            <div className="h-5/6 w-11/12">
              ...
              <button className="text-white bg-green-400 px-3 py-2 rounded-lg font-normal w-5/12">
